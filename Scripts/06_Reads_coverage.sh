...
samtools depth -aa -r "NC_031984.2:14827848-14828912" ${BWA}_${ID}_RH1.sorted.bam > ${BWA}_${ID}_RH1_CDS.sorted.bam.depth

samtools depth -aa -r "NC_031984.2:14387849-14388209" ${BWA}_${ID}_exoRH1.sorted.bam > ${BWA}_${ID}_exoRH1_CDS.sorted.bam.depth
samtools depth -aa -r "NC_031984.2:14388439-14388607" ${BWA}_${ID}_exoRH1.sorted.bam >> ${BWA}_${ID}_exoRH1_CDS.sorted.bam.depth
